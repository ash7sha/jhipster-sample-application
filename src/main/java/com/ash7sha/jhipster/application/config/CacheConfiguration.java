...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(Ash7shaProperties Ash7shaProperties) {
        ...
        config.setInstanceName("Ash7shaSampleApplication");
        ...
        config.getMapConfigs().put("default", initializeDefaultMapConfig(Ash7shaProperties));

        // Full reference is available at: http://docs.hazelcast.org/docs/management-center/3.9/manual/html/Deploying_and_Starting.html
        config.setManagementCenterConfig(initializeDefaultManagementCenterConfig(Ash7shaProperties));
        config.getMapConfigs().put("com.ash7sha.Ash7sha.application.domain.*", initializeDomainMapConfig(Ash7shaProperties));
    ...
    private ManagementCenterConfig initializeDefaultManagementCenterConfig(Ash7shaProperties Ash7shaProperties) {
        ...
        managementCenterConfig.setUpdateInterval(Ash7shaProperties.getCache().getHazelcast().getManagementCenter().getUpdateInterval());
    ...
    private MapConfig initializeDefaultMapConfig(Ash7shaProperties Ash7shaProperties) {
        ...
        */
        mapConfig.setBackupCount(Ash7shaProperties.getCache().getHazelcast().getBackupCount());
